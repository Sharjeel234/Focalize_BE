...
export const getNotification = async (title, name, description, date, email, Id) => {
...
export const smsNotification = async (title, description, phone, Id, date) => {
...
export const sendNotificationToTopic = async (req, res) => {
    ...
    try {
        ...
        const result = await novu.trigger('Focalize', {
            to: [{
                type: "Topic",
                topicKey: topicKey
            }],
